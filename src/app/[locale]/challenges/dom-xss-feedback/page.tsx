...
export default function DOMXSSChallenge() {
  ...
  const t = useTranslations('domXss');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="terminal p-6 rounded-lg">
            <div className="flex items-center space-x-2 mb-6">
              <MessageCircle className="w-6 h-6 text-blue-400" />
               <h2 className="text-xl font-mono text-green-400">{t('customerFeedback')}</h2>
            </div>
          ...
          <div className="terminal p-6 rounded-lg">
             <h2 className="text-xl font-mono text-green-400 mb-4">{t('recentFeedback')}</h2>
                ...
                {submittedFeedback.length === 0 ? (
                  <div className="text-green-300/60 text-center py-8">
                    <MessageCircle className="w-12 h-12 mx-auto mb-4 opacity-50" />
                     <p className="font-mono">{t('noFeedback')}</p>
                  </div>
                ) : null}
              </div>
            </div>
        ...
        <div className="terminal p-6 rounded-lg mt-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="vulnerable-code">
               <h4 className="font-mono text-red-400 mb-2">{t('vulnerableCode')}</h4>
            ...
            <div className="bg-green-400/5 border-l-4 border-green-400 p-3">
               <h4 className="font-mono text-green-400 mb-2">{t('tryPayloads')}</h4>
